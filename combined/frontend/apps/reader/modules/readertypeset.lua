...
function ReaderTypeset:onReadSettings(config)
    ...
    self.ui.document:setCenterNearlyFullPages(self.configurable.center_nearly_full_pages == 1)
...
function ReaderTypeset:onSetCenterNearlyFullPages(value)
    self.configurable.center_nearly_full_pages = value == 1 and 1 or 0
    self.ui.document:setCenterNearlyFullPages(value == 1)
